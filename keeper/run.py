...
if __name__ == "__main__":
    ...
    args_parser.add_argument('--ssl', action='store_true', help='Currentlu this option not implemented')
    ...
    args_parser.add_argument('--rmqhost', default='localhost', help='AMQP host')
    args_parser.add_argument('--rmqport', default=5672, help='AMQP port')
    args_parser.add_argument('--rmquser', default='guest', help='AMQP user')
    args_parser.add_argument('--rmqpass', default='guest', help='AMQP password')
